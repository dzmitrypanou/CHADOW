...
[MIT](https://opensource.org/licenses/MIT) — делайте с кодом что угодно: используйте, изменяйте, распространяйте, в том числе в коммерческих проектах. Единственное условие — сохранить уведомление об авторских правах и текст лицензии.
