...
try {
    ...
    $result = tactics_admin_update_tactics_map(
        $db,
        $mapCode,
        $game,
        $battleMode,
...
if (!$result['ok']) {
    $errors = [
        ...
        'mkdir_failed' => 'Нет прав на запись в assets/tactics/maps',
        ...
        'asset_not_found' => 'Файл карты не найден — загрузите изображение',
