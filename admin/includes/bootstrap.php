<?php
require_once dirname(__DIR__, 2) . '/includes/perf_metrics.php';
chadow_perf_start('admin_bootstrap');
...
require_once $_root . '/config/ensure_site_settings.php';
...
chadow_perf_finish('admin_bootstrap');
