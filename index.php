...
?>
        ...
        <main class="projects-landing">
            <div class="projects-grid">
                ...
                <div class="project-card project-card--disabled project-card--span-2" aria-disabled="true" data-landing-id="aim-trainers">
                    ...
                    <div class="project-card-body">
                        <div class="project-card-head">
                            ...
                            <h2 class="project-card-title">
                                ...
                                <span class="project-card-title-text">
                                    <?php echo $lang === 'en' ? 'Aim Trainer Games' : 'Aim тренажёры'; ?>
                                </span>
                            </h2>
                        </div>
                        <p class="project-card-desc">
