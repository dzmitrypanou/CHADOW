(() => {
    ...
    const TRAINER_DESCS = {
        ru: {
            ...
            gridshot: 'Три мелкие цели одновременно — сбивайте их в любом порядке, главное как можно больше.',
            duckhunt: 'Стреляйте по уткам, пролетающим через поле. Чем быстрее, точнее (за маленьких уточек больше очков) — тем выше счёт.',
            vugich: 'Попадайте в движущиеся мишени, пока прицел трясётся как при землетрясении.',
        },
        en: {
            ...
            gridshot: 'Three small targets at once — hit them in any order, score as many as you can.',
            duckhunt: 'Shoot ducks flying across the field. The faster and more accurately you shoot (small ducks score more) — the higher your score.',
