(() => {
    ...
    const STRINGS = {
        ru: {
            ...
            placementHint: 'Расставьте корабли случайным образом. Когда оба готовы — начнётся бой.',
        ...
        en: {
            ...
            placementHint: 'Place ships randomly. When both are ready, the battle begins.',
