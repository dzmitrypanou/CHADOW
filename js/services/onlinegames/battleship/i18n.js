(() => {
    ...
    const STRINGS = {
        ru: {
            ...
            placementHint: 'Перетащите корабли на поле. Колесо мыши — поворот.',
            placementDragHint: 'Колесо мыши — поворот корабля',
            dockShipsLeft: 'Осталось: {count}',
        ...
        en: {
            ...
            placementHint: 'Drag ships onto the board. Mouse wheel rotates.',
            placementDragHint: 'Mouse wheel — rotate ship',
            dockShipsLeft: 'Left: {count}',
